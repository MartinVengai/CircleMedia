...
using AutoMapper;
using CircleMedia.Authorization;
...
namespace CircleMedia
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("CircleMedia"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "CircleMedia API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CircleMedia API V1");
            });
